...
# Form 2D meshgrid
Ks = torch.stack(torch.meshgrid(ky, kx, indexing='ij'), dim=-1)  # KY.shape = [Ny, Nx, 2]
...
KY_reordered = reorder_fft_grid2(Ks.permute(2, 0, 1)) # [2, Ny, Nx]
KY_reordered = KY_reordered.permute(1, 2, 0) # [Ny, Nx, 2]
