...
if __name__ == '__main__':
    ...
    input_folder = "/Users/kx/Desktop/hmc/fignote/cmp_noncmp_result/noncmp_6810/K0_deprecated/hmc_check_point_noncmp_bench_K0"
        ...
        for J in Js:
            for bid in range(bs):
                for part_id in range(num_parts):
                    ...
                    hmc_filename = f"/stream_ckpt_N_hmc_{Lx}_Ltau_{Ltau}_Nstp_{end}_bs{bs}_Jtau_{J:.1g}_K_0_dtau_0.1_delta_0.028_N_leapfrog_5_m_1_cg_rtol_1e-09_max_block_idx_1_gear0_steps_1000_dt_deque_max_len_5_cmp_False_step_{end}.pt"
