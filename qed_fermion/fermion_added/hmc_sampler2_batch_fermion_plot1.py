...
def plot_Gtau_J():
    ...
    load_visualize_final_greens_loglog((Lx, Ly, Ltau), hmc_filename, '', local_update_filename, specifics=hmc.get_specifics(), starts=[500, 10000], ends=[Nstep, step_lmc], sample_steps=[1, 10], scale_it=[False, False])
