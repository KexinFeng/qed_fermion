...
def plot(ax: plt.Axes):
    ...
    try:
        mod = importlib.import_module('qed_fermion.observables.spin_r_noncmpK1_large8_bond_pi_flux.plot_fit_bond_corr_correction')
...
if __name__ == '__main__':
    from qed_fermion.observables.spin_r_noncmpK1_large8_bond_pi_flux.plot_fit_bond_corr_correction_plot import plot_spin_r
    plot_spin_r()