...
def plot(ax: plt.Axes):
    ...
    try:
        mod = importlib.import_module('qed_fermion.observables.spin_r_noncmpK1_large1_spsm_sup_repr2.plot_fit_spsm_r')
...
if __name__ == '__main__':
    from qed_fermion.observables.spin_r_noncmpK1_large1_spsm_sup_repr2.plot_fit_spsm_r_plot import plot_spin_r
    plot_spin_r()