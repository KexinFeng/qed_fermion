...
# HMC data folder for large9_bond_corr (cmp)
...
def plot_slope_vs_invL():
    ...
    pdf_path1 = os.path.join(save_dir, "corr_with_fits_cmp_bond.pdf")
    png_path1 = os.path.join(save_dir, "corr_with_fits_cmp_bond.png")
    ...
    pdf_path2 = os.path.join(save_dir, "slope_vs_invL_cmp_bond.pdf")
    png_path2 = os.path.join(save_dir, "slope_vs_invL_cmp_bond.png")
