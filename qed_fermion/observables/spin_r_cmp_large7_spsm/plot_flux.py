...
for i, Lx in enumerate(lattice_sizes):
    ...
    if Lx <= 40:
        ...
        Nrv = 40
        bs = 2
        hmc_file = f"ckpt_N_hmc_{Lx}_Ltau_{Ltau}_Nstp_10000_bs{bs}_Jtau_1.2_K_1_dtau_0.1_delta_0.028_N_leapfrog_5_m_1_cg_rtol_1e-09_max_block_idx_1_gear0_steps_1000_dt_deque_max_len_5_Nrv_{Nrv}_cmp_True_step_10000.pt"
    elif Lx == 56:
        ...
        Nstp = 6800
        hmc_file = f"ckpt_N_hmc_{Lx}_Ltau_{Ltau}_Nstp_{Nstp}_bs1_Jtau_1.2_K_1_dtau_0.1_delta_0.028_N_leapfrog_5_m_1_cg_rtol_1e-09_max_block_idx_1_gear0_steps_1000_dt_deque_max_len_5_Nrv_30_cmp_True_step_{Nstp}.pt"
    else:
        continue
...
man_slope = -4
man_intercept = 8.6  # Increase this to move the fit line up
