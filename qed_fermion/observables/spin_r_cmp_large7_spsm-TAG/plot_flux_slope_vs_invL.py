...
def plot_flux_slope_vs_invL():
    ...
    pdf_path1 = os.path.join(save_dir, "flux_with_fits_cmp.pdf")
    png_path1 = os.path.join(save_dir, "flux_with_fits_cmp.png")
    ...
    pdf_path2 = os.path.join(save_dir, "flux_slope_vs_invL_cmp.pdf")
    png_path2 = os.path.join(save_dir, "flux_slope_vs_invL_cmp.png")
