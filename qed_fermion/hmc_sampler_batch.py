...
class HmcSampler(object):
    ...
    def apply_sigma_hat_cpu(self, i):
        if i % self.sigma_mini_batch_size == 0 and i > 0:
            ...
            # save_dir = os.path.join(script_path, f"./figures/{class_name}_bench2")
            # os.makedirs(save_dir, exist_ok=True) 
    ...
    def measure(self):
        ...
        for i in tqdm(range(self.N_step)):
            ...
            if i % self.ckp_rate == 0 and i > 0:
                ...
                data_folder = script_path + "/check_points/hmc_check_point_bench2/"
...
def load_visualize_final_greens_loglog(Lsize=(20, 20, 20), step=1000001, 
    ...
    # Lx, Ly, Ltau = 20, 20, 20
    Lx, Ly, Ltau = Lsize
    filename = script_path + f"/check_points/hmc_check_point_bench2/ckpt_N_{specifics}_step_{step}.pt"
