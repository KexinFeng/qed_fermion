    ...
    def measure(self):
        ...
        for i in tqdm(range(self.N_step)):
            ...
            if i % self.ckp_rate == 0 and i > 0:
                ...
                data_folder = script_path + "/check_points/hmc_check_point_cmp_dbg/"
...
def load_visualize_final_greens_loglog(Lsize=(20, 20, 20), step=1000001, 
    ...
    # Lx, Ly, Ltau = 20, 20, 20
    Lx, Ly, Ltau = Lsize
    filename = script_path + f"/check_points/hmc_check_point_cmp_dbg/ckpt_N_{specifics}_step_{step}.pt"
