...
def plot_energy_J(Js=[], starts=[500], sample_steps=[1]):
    ...
    for J in Js:
        ...
        # hmc_filename = f"/Users/kx/Desktop/hmc/fignote/ftdqmc/data6810x4L/hmc_check_point/ckpt_N_hmc_6_Ltau_240_Nstp_6000_bs1_Jtau_{J:.1g}_K_1_dtau_0.1_step_6000.pt"
