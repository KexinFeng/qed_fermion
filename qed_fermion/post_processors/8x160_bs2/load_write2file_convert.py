...
if __name__ == '__main__':
    ...
    input_folder = "/Users/kx/Desktop/hmc/fignote/equilibrium_issue/hmc_check_point_various_sizes/"
        ...
        for J in Js:
            for bid in range(bs):
                for part_id in range(num_parts):
                    ...
                    hmc_filename = f"/stream_ckpt_N_hmc_{Lx}_Ltau_{Ltau}_Nstp_{12000}_bs{bs}_Jtau_{J:.2g}_K_1_dtau_0.1_delta_t_0.02_N_leapfrog_5_m_1_cg_rtol_1e-05_step_{end}.pt"
