...
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --output=./report_noncmp_bench1/%x_%j.out            # 8. Standard output log as $job_name_$job_id.out
#SBATCH --error=./report_noncmp_bench1/%x_%j.err             #    Standard error log as $job_name_$job_id.errs
